...
// 2 (1 declaration, 1 for value)
// 1 (notify)
// 1 (user description descriptor)
#define NUM_APP_GATT_ATTRIBUTES 4
...
// 36 = gatt + gap
// 23 = device name
// 27 Characteristic (16uuid 5) + (client descriptor 2) + (value len 20)
// 30 for description len
#define ATT_VALUE_ARRAY_SIZE    (36 + 23 + 27 + 30 + OTA_ATT_VALUE_ARRAY_SIZE) /* Only GATT & GAP default services, NUM_LINKS = 1 */
// #define ATT_VALUE_ARRAY_SIZE    (36 + 23 + 27 + 4 + 30  + OTA_ATT_VALUE_ARRAY_SIZE) /* Only GATT & GAP default services, NUM_LINKS = 1 */
